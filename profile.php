...
if (isset($_POST['simpan'])) {
    ...
    if ($simpan) {
        echo "<script>
            alert('Data berhasil diperbarui, silahkan refresh halaman untuk memperbarui data');
...
<form method="post" action="">
    <button type="submit" name="logout" class="btn btn-danger">Logout</button><br><br>
    <p style="font-weight: lighter; text-align: center;">
        <i>*Silahkan refresh halaman untuk memperbarui data*</i>
    </p>
</form>
